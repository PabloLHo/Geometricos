...
public:
	...
	*/
	virtual bool intersects(Line& line, Point& intersetion);
	...
	*/
	virtual bool intersects(RayLine& rayline, Point& intersetion);
	...
	*/
	virtual bool intersects(SegmentLine& segment, Point& intersetion);
