...
public:
	...
	*/
	double distancePointLine(Point& v);
	...
	*/
	virtual bool intersects(Line& line, Point& intersection);
	...
	*/
	virtual bool intersects(RayLine& rayline, Point& intersection);
	...
	*/
	virtual bool intersects(SegmentLine& segment, Point& intersection);
